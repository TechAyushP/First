...
import { contextVariable } from './../myContext/MyContext';
export let contextVariableEx=createContext()

const MyContextEx = (props) => {
  ...
  return (
    <contextVariableEx.Provider value={data}>{props.children}</contextVariableEx.Provider>
  )
}

export default MyContextEx